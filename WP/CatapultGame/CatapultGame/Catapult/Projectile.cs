...
namespace CatapultGame
{
    class Projectile : DrawableGameComponent
    {
        ...
        //1.0f, SpriteEffects.None, 0);
            ...
            spriteBatch.Draw(ProjectileTexture, projectilePosition, null, Color.White, projectileRotation,
                             new Vector2(projectileTexture.Width / 2, projectileTexture.Width / 2),
                             1.0f, SpriteEffects.None, 0);
            base.Draw(gameTime);
        }
