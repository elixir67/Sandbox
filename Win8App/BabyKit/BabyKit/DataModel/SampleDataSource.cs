...
namespace BabyKit.Data
{
    ...
    public abstract class SampleDataCommon : BabyKit.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            ...
            var groupSetting = new SampleDataGroup(GROUP_SETTING,
                    "设置",
                    "输入baby出生信息",
                    "Assets/DarkGray.png",
                    "设置信息");
            this.AllGroups.Add(groupSetting);

            var groupDate = new SampleDataGroup(GROUP_DATE,
                    "日期",
                    "显示baby出生信息",
                    "Assets/DarkGray.png",
                    "秀信息");
            this.AllGroups.Add(groupDate);

            var groupWeight = new SampleDataGroup(GROUP_WEIGHT,
                            "体重",
                            "baby体重图",
                            "Assets/DarkGray.png",
                            "体重变化");
            this.AllGroups.Add(groupWeight);

            var groupConstellation = new SampleDataGroup(GROUP_CONSTELLATION,
                    "星座",
                    "显示baby星座信息",
                    "Assets/DarkGray.png",
                    "baby星座信息");
            this.AllGroups.Add(groupConstellation);

            var groupZodiac = new SampleDataGroup(GROUP_ZODIAC,
                            "生肖",
                            "显示baby生肖信息",
                            "Assets/DarkGray.png",
                            "baby生肖信息");
