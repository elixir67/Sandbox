...
xamlpattern = re.compile(r'.+\.xaml$', re.I)
# newIconDir = '../../../Data/Resources/Visual_Assets/Icons/AirLook'
newIconDir = 'AirLookIcons/'
iconUsedByXamlPattern = re.compile(r'(.+=")(.+/)(.+\.)(png|ico|gif|jpg|bmp)(.+)', re.I)

replacedLog = csv.writer(open("replacedLog.csv", "wb"))
replacedLog.writerow(['IconName','IconExist','OldLineContent','NewLineContent','FileName','DirName'])
